...
class BaseDocEncoder(nn.Module):
    def __init__(self, config: DictConfig):
        ...
        # self.lm_encoder.half() ## Only for LLama
        ...
        # if self.lm_encoder.config.hidden_size > self.max_hidden_size:
            # self.compressor = nn.Linear(self.lm_encoder.config.hidden_size, self.max_hidden_size).to(self.device)
            # self.hidden_size = self.max_hidden_size
        # else:
